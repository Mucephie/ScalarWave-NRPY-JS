...
function integrateWasmJS() {
  var wasmTextFile = "SENR.wast";
  var wasmBinaryFile = "SENR.wasm";
  var asmjsCodeFile = "SENR.temp.asm.js";
...
var _get_gfs = (Module["_get_gfs"] = function() {
  return Module["asm"]["_get_gfs"].apply(null, arguments);
});
var _get_gfs_size = (Module["_get_gfs_size"] = function() {
  return Module["asm"]["_get_gfs_size"].apply(null, arguments);
});
var _init_sim = (Module["_init_sim"] = function() {
  return Module["asm"]["_init_sim"].apply(null, arguments);
});
...
var _print_logo = (Module["_print_logo"] = function() {
  return Module["asm"]["_print_logo"].apply(null, arguments);
});
var _run_sim = (Module["_run_sim"] = function() {
  return Module["asm"]["_run_sim"].apply(null, arguments);
});
